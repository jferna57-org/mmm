...
import net.jk.jhipster.domain.Authority;
import net.jk.jhipster.domain.User;
import net.jk.jhipster.repository.AuthorityRepository;
import net.jk.jhipster.repository.UserRepository;
import net.jk.jhipster.repository.search.UserSearchRepository;
import net.jk.jhipster.security.AuthoritiesConstants;
import net.jk.jhipster.service.MailService;
import net.jk.jhipster.service.UserService;
import net.jk.jhipster.web.rest.dto.ManagedUserDTO;
import net.jk.jhipster.web.rest.dto.UserDTO;
