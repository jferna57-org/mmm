package net.jk.jhipster.config;

import net.jk.jhipster.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("net.jk.jhipster.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("net.jk.jhipster.repository.search")
