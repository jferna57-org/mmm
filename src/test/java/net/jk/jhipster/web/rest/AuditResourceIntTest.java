...
import net.jk.jhipster.config.audit.AuditEventConverter;
import net.jk.jhipster.domain.PersistentAuditEvent;
import net.jk.jhipster.repository.PersistenceAuditEventRepository;
import net.jk.jhipster.service.AuditEventService;
