...
/**
 * Performance test for the Activo entity.
 */
class ActivoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activo entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created activo")
                .get("${new_activo_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created activo")
            .delete("${new_activo_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
